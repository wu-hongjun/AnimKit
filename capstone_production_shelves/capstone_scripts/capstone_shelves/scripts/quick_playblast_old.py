...
# Map of CS usernames to names of current students and staff
USERNAME_TO_NAME = {    'aachan23'  :   'Advaith',
                        'ixs2xu'    :   'Andrew',
                        'oazeemi'   :   'Omar',
                        'sbaker2'   :   'Sophia',
                        'kyrabb'    :   'Kyra',
...
def quick_playblast(    renderCamName = "render_cam",
                        ...
                        usingTempFile = True # Playblast temporarily to the default project path
                    ):
    '''
